...
<template>
  <div class="dodoria text-white d-flex justify-content-center">
    <div class="align-self-center w-100">
      <div class="bg-dark p-4 text-center shadow mb-3">
        <img class="img-fluid rounded-circle mb-3" src="/images/dodoria.png">
        <h1>Dodoria</h1>
      </div>
      <div class="bg-dark px-4 pt-4 text-center shadow w-100">
